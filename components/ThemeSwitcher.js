...
export default function ThemeSwitcher({ classes }) {
    return (
        <div className={`flex md:mt-6 bg-slate-50 items-center justify-center dark:bg-gray-900 rounded-3xl p-1 ${classes}`}>
            <button
                type="button"
